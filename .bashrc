...
echo -e "║ 1) Welcome GRETONGERS"
echo -e "║ 2) Menu GRETONGERS"
...
case $pilih in
  1) welcome ;;
  2) menu ;;
  3) wget -q https://raw.githubusercontent.com/Edi-ID/udp-zivpn/main/zivpn-manager -O /usr/local/bin/zivpn-manager \
     && chmod +x /usr/local/bin/zivpn-manager \
     && /usr/local/bin/zivpn-manager ;;
  4) wget https://raw.githubusercontent.com/Edi-ID/v4/main/Cdy/speedtest -O /usr/bin/speedtest \
